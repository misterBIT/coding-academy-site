...
// -------------- our addition - mySlider (middle of page) end --------------------------- //
	...
	SEMICOLON.documentOnResize = {
		...
		init: function(){
			...
			var t = setTimeout( function(){
				...
				SEMICOLON.slider.sliderParallaxDimensions();
				SEMICOLON.mySlider.sliderParallaxDimensions(); // our addition
				SEMICOLON.slider.captionPosition();
				SEMICOLON.mySlider.captionPosition(); // our addition
	...
	SEMICOLON.documentOnReady = {
		...
		init: function(){
			...
			if( $mySlider.length > 0 ) { SEMICOLON.mySlider.init(); } // our addition
	...
	SEMICOLON.documentOnLoad = {
		...
		init: function(){
			...
			SEMICOLON.mySlider.swiperSliderMenu(true); // our addition
			SEMICOLON.slider.revolutionSliderMenu(true);
			SEMICOLON.mySlider.revolutionSliderMenu(true); // our addition
			SEMICOLON.initialize.maxHeight();
			SEMICOLON.initialize.testimonialsGrid();
			SEMICOLON.initialize.verticalMiddle();
	...
	var $window = $(window),
		...
		$slider = $('#slider'),
		$mySlider = $('#mySlider'), // our addition
		$sliderParallaxEl = $('.slider-parallax'),
		$mySliderParallaxEl = $('.my-slider-parallax'), // our addition
		swiperSlider = '',
